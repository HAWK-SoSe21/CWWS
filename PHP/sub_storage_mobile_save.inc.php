<?php
    ...
    if(isset($_POST['submit'])) {
        ...
        $sql_substorage_yard = "INSERT INTO `substorage_yard_mobile` (`Substorage_mobile_cover`, `Substorage_mobile_picture`, `Substorage_mobile_category`, `Substorage_yard_fixed_Substorage_fixed_id`, `Format_Format_id`, `Properties_Properties_id`, `User_User_id`)
                                                            VALUES ('". $_POST['Substorage_mobile_cover'] ."', '".$pictureUrl."', '". $_POST['Substorage_mobile_category'] ."', '". $_POST['Substorage_yard_Substorage_id'] ."', '". $formatId."', '" . $propId . "', '" . $authenticatedUserId . "')";
