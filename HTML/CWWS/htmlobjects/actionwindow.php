...
<div  class="mainbox">
    <div id="lagerplatzanlegen" class="actionwindow">
        ...
        <form action="<?= WEBROOT?><?= UV ?>PHP/lagerplatzanlegen.inc.php" method="post" enctype="multipart/form-data">
            ...
            <input class="datenfeld" type="number" name="Storage_format_heigth"id="Storage_format_heigth">
            
            <label class="datenheader" for="Storage_format_width">Breite</label>
            <input class="datenfeld" type="number" name="Storage_format_width" id="Storage_format_width">
            
            
            <label class="datenheader" for="Storage_format_length">Länge</label>
            <input class="datenfeld" type="number" name="Storage_format_length" id="Storage_format_length">
...
<div class="mainbox">
    <div id="artikelanlegen" class="actionwindow">
        ...
        <form action="<?= WEBROOT?><?= UV ?>PHP/artikelanlegen.inc.php" method="post" enctype="multipart/form-data">
            ...
            <input class="datenfeld" type="number" name="Articel_format_height"id="Articel_format_height">
            
            <label class="datenheader" for="Articel_format_width">Breite</label>
            <input class="datenfeld" type="number" name="Articel_format_width" id="Articel_format_width">
            
            
            <label class="datenheader" for="Articel_format_length">Länge</label>
            <input class="datenfeld" type="number" name="Articel_format_length" id="Articel_format_length">
            ...
            <input  class="datenfeld" type="text" name="Articel_expiry" id="Articel_expiry">
    ...
    <div id="bearbeiten" class="actionwindow">
        ...
        <?php if(isset($_GET['storageid'])): ?>
            ...
            <form action="<?= WEBROOT?><?= UV ?>PHP/lagerplatzbearbeiten.inc.php" method="post" enctype="multipart/form-data">
                ...
                <label class="datenheader" for="Storage_format_heigth">Höhe</label>
                <input class="datenfeld" type="number" name="Storage_format_heigth" value="<?= $object->Storage_format_heigth ?>">
                
                
                <label class="datenheader" for="Storage_format_width">Breite</label>
                <input class="datenfeld" type="number" name="Storage_format_width" value="<?= $object->Storage_format_width ?>">
                
                
                <label class="datenheader" for="Storage_format_length">Länge</label>
                <input class="datenfeld" type="number" name="Storage_format_length" value="<?= $object->Storage_format_length ?>">
        ...
        <?php elseif(isset($_GET['articleid'])):?>
            ...
            <form action="<?= WEBROOT?><?= UV ?>PHP/artikelbearbeiten.inc.php" method="post" enctype="multipart/form-data">
                ...
                <label class="datenheader" for="Articel_format_height">Höhe</label>
                <input class="datenfeld" type="number" name="Articel_format_height" value="<?= $object->Articel_format_height ?>">
                
                
                <label class="datenheader" for="Articel_format_width">Breite</label>
                <input class="datenfeld" type="number" name="Articel_format_width" value="<?= $object->Articel_format_width ?>">
                
                
                <label class="datenheader" for="Articel_format_length">Länge</label>
                <input class="datenfeld" type="number" name="Articel_format_length" value="<?= $object->Articel_format_length ?>">
                ...
                <label class="datenheader" for="Articel_expiry">Ablaufdatum</label>
                <input class="datenfeld" type="text" name="Articel_expiry" value="<?= $object->Articel_expiry ?>">
