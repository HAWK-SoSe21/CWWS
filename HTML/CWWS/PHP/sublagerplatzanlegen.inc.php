<?php
    ...
    if(isset($_POST['submit'])) {
        ...
        $sql_substorage_yard = "INSERT INTO `substorage_yard`(`Substorage_yard_picture`,`Properties_Properties_id`, `Substorage_quantity`, `Substorage_category`, `Storage_yard_Storage_id`) VALUES ('".$pictureUrl."', '". $propId."', '".$_POST["Substorage_quantity"]. "', '".$_POST["Substorage_category"]. "', '".$_POST["Storage_yard_Storage_id"]. "')";
