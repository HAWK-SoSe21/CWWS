<?php
    ...
    if(isset($_POST['submit'])) {
        ...
        $sql_usage = "INSERT INTO `usage_statistics`() VALUES ();";
        $usageId = setData($sql_usage);
        $sql_storage_yard = "INSERT INTO `storage_yard`(`Storage_picture`, `Storage_last_modified`, `Usage_statistics_idUsage_statistics`, `Format_Format_id`,`Properties_Properties_id`, `user_User_id`)
                            VALUES ('".$pictureUrl."', '".$modified_date."','".$usageId."', '".$formatId."', '".$propId."', '".$authenticatedUserId."')";
