...
if(isset($_POST['submit'])) {
  if($_FILES["Substorage_yard_picture"]['name']) {
    ...
    $sql = "UPDATE `substorage_yard` SET `User_User_id` = '". $authenticatedUserId ."', `Substorage_quantity` = '". $_POST['Substorage_quantity'] ."', `Substorage_category` = '". $_POST['Substorage_category'] ."', `Storage_yard_Storage_id` = '". $_POST['Storage_yard_Storage_id'] ."', `Substorage_yard_picture` = '". $pictureUrl ."' WHERE `Substorage_id` = '". $_POST['Substorage_id'] ."'";
  } else {
    $sql = "UPDATE `substorage_yard` SET `User_User_id` = '". $authenticatedUserId ."', `Substorage_quantity` = '". $_POST['Substorage_quantity'] ."', `Substorage_category` = '". $_POST['Substorage_category'] ."', `Storage_yard_Storage_id` = '". $_POST['Storage_yard_Storage_id'] ."' WHERE `Substorage_id` = '". $_POST['Substorage_id'] ."'";
  }
