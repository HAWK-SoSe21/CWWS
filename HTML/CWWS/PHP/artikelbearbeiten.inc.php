...
try{
    ...
    if(isset($_POST['submit'])) {
      if($_FILES["Articel_picture"]['name']) {
        ...
        $sql = "UPDATE `articel` SET `User_User_id` = '". $authenticatedUserId ."', `Articel_expiry` = '". $_POST['Articel_expiry'] ."', `aliase` = '". $_POST['Articel_alias'] ."', `Articel_picture` = '". $pictureUrl ."', `Substorage_yard_Substorage_mobile_id` = '". $_POST['Substorage_yard_Substorage_mobile_id'] ."' WHERE `Articel_id` = '". $_POST['Articel_id'] ."'";
      } else {
        $sql = "UPDATE `articel` SET `User_User_id` = '". $authenticatedUserId ."', `Articel_expiry` = '". $_POST['Articel_expiry'] ."', `aliase` = '". $_POST['Articel_alias'] ."', `Substorage_yard_Substorage_mobile_id` = '". $_POST['Substorage_yard_Substorage_mobile_id'] ."' WHERE `Articel_id` = '". $_POST['Articel_id'] ."'";
      }
