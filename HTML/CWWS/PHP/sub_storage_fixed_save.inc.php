<?php
    ...
    if(isset($_POST['submit'])) {
        ...
        $sql_substorage_yard = "INSERT INTO `substorage_yard_fixed`(`Substorage_fixed_picture`,`Properties_Properties_id`, `Substorage_fixed_category`, `Substorage_yard_Substorage_id`, `Format_Format_id`) VALUES ('".$pictureUrl."', '". $propId."', '".$_POST["Substorage_fixed_category"]. "', '".$_POST["Substorage_yard_Substorage_id"]. "', '" . $formatId . "')";
